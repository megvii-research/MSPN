...
std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor> batch_norm_collect_grad_statistics_cuda(
    const at::Tensor input,
...
std::tuple<at::Tensor, at::Tensor> batch_norm_collect_statistics_cuda(
    const at::Tensor input);
...
at::Tensor batch_norm_transform_input(
    ...
    return batch_norm_transform_input_cuda(input, gamma, beta, ex, exs, eps);
}

std::tuple<at::Tensor,at::Tensor,at::Tensor,at::Tensor> batch_norm_collect_grad_statistics(
    const at::Tensor input,
    const at::Tensor gradoutput,
    const at::Tensor gamma,
    const at::Tensor ex,
    ...
    return batch_norm_collect_grad_statistics_cuda(input, gradoutput, gamma, ex, exs, eps);
}
...
at::Tensor batch_norm_input_backward(
    ...
    return batch_norm_input_backward_cuda(input, gradoutput, gamma, ex, exs, gradex, gradexs, eps);
}

std::tuple<at::Tensor, at::Tensor> batch_norm_collect_statistics(
    const at::Tensor input) {
    CHECK_INPUT(input);
